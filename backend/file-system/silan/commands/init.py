...
"""
            ...
            console.print("[green]✅ Backend configuration created[/green]")
            console.print(f"[blue]📄 Startup script: {script_file}[/blue]")
            
        except Exception as e:
            console.print(f"[yellow]⚠️ Backend setup partially failed: {e}[/yellow]")
...
"""
    ...
    def _show_completion_message(self):
        ...
        base_message = f"""[bold green]🎉 Project '{self.project_name}' initialized successfully![/bold green]
...
[bold green]🚀 Backend Features:[/bold green]
• REST API endpoints for all content
...
├── silan-config.json"""
        ...
        if self.with_backend:
            content_structure += """
├── .silan/backend/backend-config.yaml
└── start-backend.sh"""
