...
func (uu *UserUpdate) AddSocialLinkIDs(ids ...uuid.UUID) *UserUpdate {
	uu.mutation.AddSocialLinkIDs(ids...)
	return uu
}

// AddSocialLinks adds the "social_links" edges to the SocialLink entity.
func (uu *UserUpdate) AddSocialLinks(s ...*SocialLink) *UserUpdate {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return uu.AddSocialLinkIDs(ids...)
}
...
func (uu *UserUpdate) AddBlogSeriesIDs(ids ...uuid.UUID) *UserUpdate {
	uu.mutation.AddBlogSeriesIDs(ids...)
	return uu
}

// AddBlogSeries adds the "blog_series" edges to the BlogSeries entity.
func (uu *UserUpdate) AddBlogSeries(b ...*BlogSeries) *UserUpdate {
	ids := make([]uuid.UUID, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return uu.AddBlogSeriesIDs(ids...)
}
...
func (uu *UserUpdate) ClearSocialLinks() *UserUpdate {
	uu.mutation.ClearSocialLinks()
	return uu
}

// RemoveSocialLinkIDs removes the "social_links" edge to SocialLink entities by IDs.
func (uu *UserUpdate) RemoveSocialLinkIDs(ids ...uuid.UUID) *UserUpdate {
	uu.mutation.RemoveSocialLinkIDs(ids...)
	return uu
}

// RemoveSocialLinks removes "social_links" edges to SocialLink entities.
func (uu *UserUpdate) RemoveSocialLinks(s ...*SocialLink) *UserUpdate {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return uu.RemoveSocialLinkIDs(ids...)
}
...
// ClearBlogSeries clears all "blog_series" edges to the BlogSeries entity.
func (uu *UserUpdate) ClearBlogSeries() *UserUpdate {
	uu.mutation.ClearBlogSeries()
	return uu
}

// RemoveBlogSeriesIDs removes the "blog_series" edge to BlogSeries entities by IDs.
func (uu *UserUpdate) RemoveBlogSeriesIDs(ids ...uuid.UUID) *UserUpdate {
	uu.mutation.RemoveBlogSeriesIDs(ids...)
	return uu
}

// RemoveBlogSeries removes "blog_series" edges to BlogSeries entities.
func (uu *UserUpdate) RemoveBlogSeries(b ...*BlogSeries) *UserUpdate {
	ids := make([]uuid.UUID, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return uu.RemoveBlogSeriesIDs(ids...)
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if uu.mutation.SocialLinksCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialLinksTable,
			Columns: []string{user.SocialLinksColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := uu.mutation.RemovedSocialLinksIDs(); len(nodes) > 0 && !uu.mutation.SocialLinksCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialLinksTable,
	...
	if nodes := uu.mutation.SocialLinksIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialLinksTable,
	...
	if uu.mutation.BlogSeriesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.BlogSeriesTable,
			Columns: []string{user.BlogSeriesColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := uu.mutation.RemovedBlogSeriesIDs(); len(nodes) > 0 && !uu.mutation.BlogSeriesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.BlogSeriesTable,
	...
	if nodes := uu.mutation.BlogSeriesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.BlogSeriesTable,
...
// AddSocialLinkIDs adds the "social_links" edge to the SocialLink entity by IDs.
func (uuo *UserUpdateOne) AddSocialLinkIDs(ids ...uuid.UUID) *UserUpdateOne {
	uuo.mutation.AddSocialLinkIDs(ids...)
	return uuo
}

// AddSocialLinks adds the "social_links" edges to the SocialLink entity.
func (uuo *UserUpdateOne) AddSocialLinks(s ...*SocialLink) *UserUpdateOne {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return uuo.AddSocialLinkIDs(ids...)
}
...
// AddBlogSeriesIDs adds the "blog_series" edge to the BlogSeries entity by IDs.
func (uuo *UserUpdateOne) AddBlogSeriesIDs(ids ...uuid.UUID) *UserUpdateOne {
	uuo.mutation.AddBlogSeriesIDs(ids...)
	return uuo
}

// AddBlogSeries adds the "blog_series" edges to the BlogSeries entity.
func (uuo *UserUpdateOne) AddBlogSeries(b ...*BlogSeries) *UserUpdateOne {
	ids := make([]uuid.UUID, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return uuo.AddBlogSeriesIDs(ids...)
}
...
// ClearSocialLinks clears all "social_links" edges to the SocialLink entity.
func (uuo *UserUpdateOne) ClearSocialLinks() *UserUpdateOne {
	uuo.mutation.ClearSocialLinks()
	return uuo
}

// RemoveSocialLinkIDs removes the "social_links" edge to SocialLink entities by IDs.
func (uuo *UserUpdateOne) RemoveSocialLinkIDs(ids ...uuid.UUID) *UserUpdateOne {
	uuo.mutation.RemoveSocialLinkIDs(ids...)
	return uuo
}

// RemoveSocialLinks removes "social_links" edges to SocialLink entities.
func (uuo *UserUpdateOne) RemoveSocialLinks(s ...*SocialLink) *UserUpdateOne {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return uuo.RemoveSocialLinkIDs(ids...)
}
...
// ClearBlogSeries clears all "blog_series" edges to the BlogSeries entity.
func (uuo *UserUpdateOne) ClearBlogSeries() *UserUpdateOne {
	uuo.mutation.ClearBlogSeries()
	return uuo
}

// RemoveBlogSeriesIDs removes the "blog_series" edge to BlogSeries entities by IDs.
func (uuo *UserUpdateOne) RemoveBlogSeriesIDs(ids ...uuid.UUID) *UserUpdateOne {
	uuo.mutation.RemoveBlogSeriesIDs(ids...)
	return uuo
}

// RemoveBlogSeries removes "blog_series" edges to BlogSeries entities.
func (uuo *UserUpdateOne) RemoveBlogSeries(b ...*BlogSeries) *UserUpdateOne {
	ids := make([]uuid.UUID, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return uuo.RemoveBlogSeriesIDs(ids...)
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if uuo.mutation.SocialLinksCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialLinksTable,
	...
	if nodes := uuo.mutation.RemovedSocialLinksIDs(); len(nodes) > 0 && !uuo.mutation.SocialLinksCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialLinksTable,
	...
	if nodes := uuo.mutation.SocialLinksIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SocialLinksTable,
	...
	if uuo.mutation.BlogSeriesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.BlogSeriesTable,
	...
	if nodes := uuo.mutation.RemovedBlogSeriesIDs(); len(nodes) > 0 && !uuo.mutation.BlogSeriesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.BlogSeriesTable,
	...
	if nodes := uuo.mutation.BlogSeriesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.BlogSeriesTable,
