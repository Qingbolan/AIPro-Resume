...
func (bpc *BlogPostCreate) SetUserID(id uuid.UUID) *BlogPostCreate {
	bpc.mutation.SetUserID(id)
	return bpc
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (bpc *BlogPostCreate) SetNillableUserID(id *uuid.UUID) *BlogPostCreate {
	if id != nil {
		bpc = bpc.SetUserID(*id)
	}
	return bpc
}
...
func (bpc *BlogPostCreate) SetCategoryID(id uuid.UUID) *BlogPostCreate {
	bpc.mutation.SetCategoryID(id)
	return bpc
}

// SetNillableCategoryID sets the "category" edge to the BlogCategory entity by ID if the given value is not nil.
func (bpc *BlogPostCreate) SetNillableCategoryID(id *uuid.UUID) *BlogPostCreate {
	if id != nil {
		bpc = bpc.SetCategoryID(*id)
	}
	return bpc
}
...
func (bpc *BlogPostCreate) SetSeriesID(id uuid.UUID) *BlogPostCreate {
	bpc.mutation.SetSeriesID(id)
	return bpc
}

// SetNillableSeriesID sets the "series" edge to the BlogSeries entity by ID if the given value is not nil.
func (bpc *BlogPostCreate) SetNillableSeriesID(id *uuid.UUID) *BlogPostCreate {
	if id != nil {
		bpc = bpc.SetSeriesID(*id)
	}
	return bpc
}
...
func (bpc *BlogPostCreate) createSpec() (*BlogPost, *sqlgraph.CreateSpec) {
	...
	if nodes := bpc.mutation.CategoryIDs(); len(nodes) > 0 {
		...
		_node.blog_category_blog_posts = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := bpc.mutation.SeriesIDs(); len(nodes) > 0 {
		...
		_node.blog_series_blog_posts = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
