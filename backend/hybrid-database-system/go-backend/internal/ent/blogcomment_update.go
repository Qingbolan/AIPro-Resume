...
func (bcu *BlogCommentUpdate) SetIsSpam(b bool) *BlogCommentUpdate {
	bcu.mutation.SetIsSpam(b)
	return bcu
}

// SetNillableIsSpam sets the "is_spam" field if the given value is not nil.
func (bcu *BlogCommentUpdate) SetNillableIsSpam(b *bool) *BlogCommentUpdate {
	if b != nil {
		bcu.SetIsSpam(*b)
	}
	return bcu
...
func (bcu *BlogCommentUpdate) SetLikeCount(i int) *BlogCommentUpdate {
	bcu.mutation.ResetLikeCount()
	bcu.mutation.SetLikeCount(i)
	return bcu
}

// SetNillableLikeCount sets the "like_count" field if the given value is not nil.
func (bcu *BlogCommentUpdate) SetNillableLikeCount(i *int) *BlogCommentUpdate {
	if i != nil {
		bcu.SetLikeCount(*i)
	}
	return bcu
...
func (bcu *BlogCommentUpdate) AddLikeCount(i int) *BlogCommentUpdate {
	bcu.mutation.AddLikeCount(i)
	return bcu
}

// SetDislikeCount sets the "dislike_count" field.
func (bcu *BlogCommentUpdate) SetDislikeCount(i int) *BlogCommentUpdate {
	bcu.mutation.ResetDislikeCount()
	bcu.mutation.SetDislikeCount(i)
	return bcu
}

// SetNillableDislikeCount sets the "dislike_count" field if the given value is not nil.
func (bcu *BlogCommentUpdate) SetNillableDislikeCount(i *int) *BlogCommentUpdate {
	if i != nil {
		bcu.SetDislikeCount(*i)
	}
	return bcu
}

// AddDislikeCount adds i to the "dislike_count" field.
func (bcu *BlogCommentUpdate) AddDislikeCount(i int) *BlogCommentUpdate {
	bcu.mutation.AddDislikeCount(i)
	return bcu
}

// SetCreatedAt sets the "created_at" field.
func (bcu *BlogCommentUpdate) SetCreatedAt(t time.Time) *BlogCommentUpdate {
	bcu.mutation.SetCreatedAt(t)
	return bcu
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (bcu *BlogCommentUpdate) SetNillableCreatedAt(t *time.Time) *BlogCommentUpdate {
	if t != nil {
		bcu.SetCreatedAt(*t)
	}
	return bcu
...
func (bcu *BlogCommentUpdate) SetPostID(id uuid.UUID) *BlogCommentUpdate {
	bcu.mutation.SetPostID(id)
	return bcu
}

// SetNillablePostID sets the "post" edge to the BlogPost entity by ID if the given value is not nil.
func (bcu *BlogCommentUpdate) SetNillablePostID(id *uuid.UUID) *BlogCommentUpdate {
	if id != nil {
		bcu = bcu.SetPostID(*id)
	}
	return bcu
}

// SetPost sets the "post" edge to the BlogPost entity.
func (bcu *BlogCommentUpdate) SetPost(b *BlogPost) *BlogCommentUpdate {
	return bcu.SetPostID(b.ID)
}
...
func (bcu *BlogCommentUpdate) ClearPost() *BlogCommentUpdate {
	bcu.mutation.ClearPost()
	return bcu
}
...
func (bcu *BlogCommentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := bcu.mutation.BlogPostID(); ok {
		_spec.SetField(blogcomment.FieldBlogPostID, field.TypeUUID, value)
	}
	...
	if value, ok := bcu.mutation.IsSpam(); ok {
		_spec.SetField(blogcomment.FieldIsSpam, field.TypeBool, value)
	}
	...
	if value, ok := bcu.mutation.LikeCount(); ok {
		_spec.SetField(blogcomment.FieldLikeCount, field.TypeInt, value)
	}
	if value, ok := bcu.mutation.AddedLikeCount(); ok {
		_spec.AddField(blogcomment.FieldLikeCount, field.TypeInt, value)
	}
	if value, ok := bcu.mutation.DislikeCount(); ok {
		_spec.SetField(blogcomment.FieldDislikeCount, field.TypeInt, value)
	}
	if value, ok := bcu.mutation.AddedDislikeCount(); ok {
		_spec.AddField(blogcomment.FieldDislikeCount, field.TypeInt, value)
	}
	...
	if bcu.mutation.PostCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   blogcomment.PostTable,
			Columns: []string{blogcomment.PostColumn},
			Bidi:    false,
	...
	if nodes := bcu.mutation.PostIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   blogcomment.PostTable,
...
// SetIsSpam sets the "is_spam" field.
func (bcuo *BlogCommentUpdateOne) SetIsSpam(b bool) *BlogCommentUpdateOne {
	bcuo.mutation.SetIsSpam(b)
	return bcuo
}

// SetNillableIsSpam sets the "is_spam" field if the given value is not nil.
func (bcuo *BlogCommentUpdateOne) SetNillableIsSpam(b *bool) *BlogCommentUpdateOne {
	if b != nil {
		bcuo.SetIsSpam(*b)
	}
	return bcuo
...
// SetLikeCount sets the "like_count" field.
func (bcuo *BlogCommentUpdateOne) SetLikeCount(i int) *BlogCommentUpdateOne {
	bcuo.mutation.ResetLikeCount()
	bcuo.mutation.SetLikeCount(i)
	return bcuo
}

// SetNillableLikeCount sets the "like_count" field if the given value is not nil.
func (bcuo *BlogCommentUpdateOne) SetNillableLikeCount(i *int) *BlogCommentUpdateOne {
	if i != nil {
		bcuo.SetLikeCount(*i)
	}
	return bcuo
...
// AddLikeCount adds i to the "like_count" field.
func (bcuo *BlogCommentUpdateOne) AddLikeCount(i int) *BlogCommentUpdateOne {
	bcuo.mutation.AddLikeCount(i)
	return bcuo
}

// SetDislikeCount sets the "dislike_count" field.
func (bcuo *BlogCommentUpdateOne) SetDislikeCount(i int) *BlogCommentUpdateOne {
	bcuo.mutation.ResetDislikeCount()
	bcuo.mutation.SetDislikeCount(i)
	return bcuo
}

// SetNillableDislikeCount sets the "dislike_count" field if the given value is not nil.
func (bcuo *BlogCommentUpdateOne) SetNillableDislikeCount(i *int) *BlogCommentUpdateOne {
	if i != nil {
		bcuo.SetDislikeCount(*i)
	}
	return bcuo
}

// AddDislikeCount adds i to the "dislike_count" field.
func (bcuo *BlogCommentUpdateOne) AddDislikeCount(i int) *BlogCommentUpdateOne {
	bcuo.mutation.AddDislikeCount(i)
	return bcuo
}

// SetCreatedAt sets the "created_at" field.
func (bcuo *BlogCommentUpdateOne) SetCreatedAt(t time.Time) *BlogCommentUpdateOne {
	bcuo.mutation.SetCreatedAt(t)
	return bcuo
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (bcuo *BlogCommentUpdateOne) SetNillableCreatedAt(t *time.Time) *BlogCommentUpdateOne {
	if t != nil {
		bcuo.SetCreatedAt(*t)
	}
	return bcuo
...
// SetPostID sets the "post" edge to the BlogPost entity by ID.
func (bcuo *BlogCommentUpdateOne) SetPostID(id uuid.UUID) *BlogCommentUpdateOne {
	bcuo.mutation.SetPostID(id)
	return bcuo
}

// SetNillablePostID sets the "post" edge to the BlogPost entity by ID if the given value is not nil.
func (bcuo *BlogCommentUpdateOne) SetNillablePostID(id *uuid.UUID) *BlogCommentUpdateOne {
	if id != nil {
		bcuo = bcuo.SetPostID(*id)
	}
	return bcuo
}

// SetPost sets the "post" edge to the BlogPost entity.
func (bcuo *BlogCommentUpdateOne) SetPost(b *BlogPost) *BlogCommentUpdateOne {
	return bcuo.SetPostID(b.ID)
}
...
// ClearPost clears the "post" edge to the BlogPost entity.
func (bcuo *BlogCommentUpdateOne) ClearPost() *BlogCommentUpdateOne {
	bcuo.mutation.ClearPost()
	return bcuo
}
...
func (bcuo *BlogCommentUpdateOne) sqlSave(ctx context.Context) (_node *BlogComment, err error) {
	...
	if value, ok := bcuo.mutation.BlogPostID(); ok {
		_spec.SetField(blogcomment.FieldBlogPostID, field.TypeUUID, value)
	}
	...
	if value, ok := bcuo.mutation.IsSpam(); ok {
		_spec.SetField(blogcomment.FieldIsSpam, field.TypeBool, value)
	}
	...
	if value, ok := bcuo.mutation.LikeCount(); ok {
		_spec.SetField(blogcomment.FieldLikeCount, field.TypeInt, value)
	}
	if value, ok := bcuo.mutation.AddedLikeCount(); ok {
		_spec.AddField(blogcomment.FieldLikeCount, field.TypeInt, value)
	}
	if value, ok := bcuo.mutation.DislikeCount(); ok {
		_spec.SetField(blogcomment.FieldDislikeCount, field.TypeInt, value)
	}
	if value, ok := bcuo.mutation.AddedDislikeCount(); ok {
		_spec.AddField(blogcomment.FieldDislikeCount, field.TypeInt, value)
	}
	...
	if nodes := bcuo.mutation.PostIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   blogcomment.PostTable,
