...
func (bcc *BlogCommentCreate) SetIsSpam(b bool) *BlogCommentCreate {
	bcc.mutation.SetIsSpam(b)
	return bcc
}

// SetNillableIsSpam sets the "is_spam" field if the given value is not nil.
func (bcc *BlogCommentCreate) SetNillableIsSpam(b *bool) *BlogCommentCreate {
	if b != nil {
		bcc.SetIsSpam(*b)
	}
	return bcc
...
func (bcc *BlogCommentCreate) SetLikeCount(i int) *BlogCommentCreate {
	bcc.mutation.SetLikeCount(i)
	return bcc
}

// SetNillableLikeCount sets the "like_count" field if the given value is not nil.
func (bcc *BlogCommentCreate) SetNillableLikeCount(i *int) *BlogCommentCreate {
	if i != nil {
		bcc.SetLikeCount(*i)
	}
	return bcc
...
func (bcc *BlogCommentCreate) SetDislikeCount(i int) *BlogCommentCreate {
	bcc.mutation.SetDislikeCount(i)
	return bcc
}

// SetNillableDislikeCount sets the "dislike_count" field if the given value is not nil.
func (bcc *BlogCommentCreate) SetNillableDislikeCount(i *int) *BlogCommentCreate {
	if i != nil {
		bcc.SetDislikeCount(*i)
	}
	return bcc
}
...
func (bcc *BlogCommentCreate) SetPostID(id uuid.UUID) *BlogCommentCreate {
	bcc.mutation.SetPostID(id)
	return bcc
}

// SetNillablePostID sets the "post" edge to the BlogPost entity by ID if the given value is not nil.
func (bcc *BlogCommentCreate) SetNillablePostID(id *uuid.UUID) *BlogCommentCreate {
	if id != nil {
		bcc = bcc.SetPostID(*id)
	}
	return bcc
}

// SetPost sets the "post" edge to the BlogPost entity.
func (bcc *BlogCommentCreate) SetPost(b *BlogPost) *BlogCommentCreate {
	return bcc.SetPostID(b.ID)
}
...
func (bcc *BlogCommentCreate) defaults() {
	...
	if _, ok := bcc.mutation.IsSpam(); !ok {
		v := blogcomment.DefaultIsSpam
		bcc.mutation.SetIsSpam(v)
	}
	if _, ok := bcc.mutation.LikeCount(); !ok {
		v := blogcomment.DefaultLikeCount
		bcc.mutation.SetLikeCount(v)
	}
	if _, ok := bcc.mutation.DislikeCount(); !ok {
		v := blogcomment.DefaultDislikeCount
		bcc.mutation.SetDislikeCount(v)
	}
...
func (bcc *BlogCommentCreate) check() error {
	...
	if _, ok := bcc.mutation.IsSpam(); !ok {
		return &ValidationError{Name: "is_spam", err: errors.New(`ent: missing required field "BlogComment.is_spam"`)}
	}
	...
	if _, ok := bcc.mutation.LikeCount(); !ok {
		return &ValidationError{Name: "like_count", err: errors.New(`ent: missing required field "BlogComment.like_count"`)}
	}
	if _, ok := bcc.mutation.DislikeCount(); !ok {
		return &ValidationError{Name: "dislike_count", err: errors.New(`ent: missing required field "BlogComment.dislike_count"`)}
	}
	if _, ok := bcc.mutation.CreatedAt(); !ok {
...
func (bcc *BlogCommentCreate) createSpec() (*BlogComment, *sqlgraph.CreateSpec) {
	...
	if value, ok := bcc.mutation.BlogPostID(); ok {
	...
	if value, ok := bcc.mutation.IsSpam(); ok {
	...
	if nodes := bcc.mutation.PostIDs(); len(nodes) > 0 {
		...
		_node.blog_post_comments = &nodes[0]
