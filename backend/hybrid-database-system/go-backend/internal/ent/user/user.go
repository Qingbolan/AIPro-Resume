...
const (
	...
	PersonalInfoColumn = "user_personal_info"
	...
	SocialLinksColumn = "user_social_links"
	...
	EducationColumn = "user_education"
	...
	WorkExperienceInverseTable = "work_experiences"
	// WorkExperienceColumn is the table column denoting the work_experience relation/edge.
	WorkExperienceColumn = "user_work_experience"
	...
	BlogSeriesColumn = "user_blog_series"
	...
	ResearchProjectsColumn = "user_research_projects"
	...
	PublicationsColumn = "user_publications"
...
// ByBlogSeriesCount orders the results by blog_series count.
func ByBlogSeriesCount(opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborsCount(s, newBlogSeriesStep(), opts...)
	}
}

// ByBlogSeries orders the results by blog_series terms.
func ByBlogSeries(term sql.OrderTerm, terms ...sql.OrderTerm) OrderOption {
	return func(s *sql.Selector) {
		sqlgraph.OrderByNeighborTerms(s, newBlogSeriesStep(), append([]sql.OrderTerm{term}, terms...)...)
	}
}
...
func newBlogSeriesStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		...
		sqlgraph.Edge(sqlgraph.O2M, false, BlogSeriesTable, BlogSeriesColumn),
	)
}
