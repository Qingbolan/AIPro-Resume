...
func HasSocialLinks() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasSocialLinksWith(preds ...predicate.SocialLink) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasBlogSeries() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBlogSeriesWith(preds ...predicate.BlogSeries) predicate.User {
	return predicate.User(func(s *sql.Selector) {
