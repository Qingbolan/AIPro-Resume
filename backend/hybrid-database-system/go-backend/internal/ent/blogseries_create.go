...
func (bsc *BlogSeriesCreate) SetFeaturedImageURL(s string) *BlogSeriesCreate {
	bsc.mutation.SetFeaturedImageURL(s)
	return bsc
}

// SetNillableFeaturedImageURL sets the "featured_image_url" field if the given value is not nil.
func (bsc *BlogSeriesCreate) SetNillableFeaturedImageURL(s *string) *BlogSeriesCreate {
	if s != nil {
		bsc.SetFeaturedImageURL(*s)
	}
	return bsc
}

// SetPostCount sets the "post_count" field.
func (bsc *BlogSeriesCreate) SetPostCount(i int) *BlogSeriesCreate {
	bsc.mutation.SetPostCount(i)
	return bsc
}

// SetNillablePostCount sets the "post_count" field if the given value is not nil.
func (bsc *BlogSeriesCreate) SetNillablePostCount(i *int) *BlogSeriesCreate {
	if i != nil {
		bsc.SetPostCount(*i)
	}
	return bsc
...
func (bsc *BlogSeriesCreate) SetIsCompleted(b bool) *BlogSeriesCreate {
	bsc.mutation.SetIsCompleted(b)
	return bsc
}

// SetNillableIsCompleted sets the "is_completed" field if the given value is not nil.
func (bsc *BlogSeriesCreate) SetNillableIsCompleted(b *bool) *BlogSeriesCreate {
	if b != nil {
		bsc.SetIsCompleted(*b)
	}
	return bsc
}
...
func (bsc *BlogSeriesCreate) SetUserID(id uuid.UUID) *BlogSeriesCreate {
	bsc.mutation.SetUserID(id)
	return bsc
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (bsc *BlogSeriesCreate) SetNillableUserID(id *uuid.UUID) *BlogSeriesCreate {
	if id != nil {
		bsc = bsc.SetUserID(*id)
	}
	return bsc
}

// SetUser sets the "user" edge to the User entity.
func (bsc *BlogSeriesCreate) SetUser(u *User) *BlogSeriesCreate {
	return bsc.SetUserID(u.ID)
}
...
func (bsc *BlogSeriesCreate) defaults() {
	if _, ok := bsc.mutation.PostCount(); !ok {
		v := blogseries.DefaultPostCount
		bsc.mutation.SetPostCount(v)
	}
	if _, ok := bsc.mutation.IsCompleted(); !ok {
		v := blogseries.DefaultIsCompleted
		bsc.mutation.SetIsCompleted(v)
	}
...
func (bsc *BlogSeriesCreate) check() error {
	...
	if v, ok := bsc.mutation.FeaturedImageURL(); ok {
	...
	if _, ok := bsc.mutation.PostCount(); !ok {
		return &ValidationError{Name: "post_count", err: errors.New(`ent: missing required field "BlogSeries.post_count"`)}
	}
	if _, ok := bsc.mutation.IsCompleted(); !ok {
		return &ValidationError{Name: "is_completed", err: errors.New(`ent: missing required field "BlogSeries.is_completed"`)}
	}
	if _, ok := bsc.mutation.CreatedAt(); !ok {
...
func (bsc *BlogSeriesCreate) createSpec() (*BlogSeries, *sqlgraph.CreateSpec) {
	...
	if nodes := bsc.mutation.UserIDs(); len(nodes) > 0 {
		...
		_node.user_blog_series = &nodes[0]
