...
func (bpu *BlogPostUpdate) SetCreatedAt(t time.Time) *BlogPostUpdate {
	bpu.mutation.SetCreatedAt(t)
	return bpu
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (bpu *BlogPostUpdate) SetNillableCreatedAt(t *time.Time) *BlogPostUpdate {
	if t != nil {
		bpu.SetCreatedAt(*t)
	}
	return bpu
...
func (bpu *BlogPostUpdate) SetUserID(id uuid.UUID) *BlogPostUpdate {
	bpu.mutation.SetUserID(id)
	return bpu
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (bpu *BlogPostUpdate) SetNillableUserID(id *uuid.UUID) *BlogPostUpdate {
	if id != nil {
		bpu = bpu.SetUserID(*id)
	}
	return bpu
}
...
func (bpu *BlogPostUpdate) SetCategoryID(id uuid.UUID) *BlogPostUpdate {
	bpu.mutation.SetCategoryID(id)
	return bpu
}

// SetNillableCategoryID sets the "category" edge to the BlogCategory entity by ID if the given value is not nil.
func (bpu *BlogPostUpdate) SetNillableCategoryID(id *uuid.UUID) *BlogPostUpdate {
	if id != nil {
		bpu = bpu.SetCategoryID(*id)
	}
	return bpu
}
...
func (bpu *BlogPostUpdate) SetSeriesID(id uuid.UUID) *BlogPostUpdate {
	bpu.mutation.SetSeriesID(id)
	return bpu
}

// SetNillableSeriesID sets the "series" edge to the BlogSeries entity by ID if the given value is not nil.
func (bpu *BlogPostUpdate) SetNillableSeriesID(id *uuid.UUID) *BlogPostUpdate {
	if id != nil {
		bpu = bpu.SetSeriesID(*id)
	}
	return bpu
}
...
// SetCreatedAt sets the "created_at" field.
func (bpuo *BlogPostUpdateOne) SetCreatedAt(t time.Time) *BlogPostUpdateOne {
	bpuo.mutation.SetCreatedAt(t)
	return bpuo
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (bpuo *BlogPostUpdateOne) SetNillableCreatedAt(t *time.Time) *BlogPostUpdateOne {
	if t != nil {
		bpuo.SetCreatedAt(*t)
	}
	return bpuo
...
// SetUserID sets the "user" edge to the User entity by ID.
func (bpuo *BlogPostUpdateOne) SetUserID(id uuid.UUID) *BlogPostUpdateOne {
	bpuo.mutation.SetUserID(id)
	return bpuo
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (bpuo *BlogPostUpdateOne) SetNillableUserID(id *uuid.UUID) *BlogPostUpdateOne {
	if id != nil {
		bpuo = bpuo.SetUserID(*id)
	}
	return bpuo
}
...
// SetCategoryID sets the "category" edge to the BlogCategory entity by ID.
func (bpuo *BlogPostUpdateOne) SetCategoryID(id uuid.UUID) *BlogPostUpdateOne {
	bpuo.mutation.SetCategoryID(id)
	return bpuo
}

// SetNillableCategoryID sets the "category" edge to the BlogCategory entity by ID if the given value is not nil.
func (bpuo *BlogPostUpdateOne) SetNillableCategoryID(id *uuid.UUID) *BlogPostUpdateOne {
	if id != nil {
		bpuo = bpuo.SetCategoryID(*id)
	}
	return bpuo
}
...
// SetSeriesID sets the "series" edge to the BlogSeries entity by ID.
func (bpuo *BlogPostUpdateOne) SetSeriesID(id uuid.UUID) *BlogPostUpdateOne {
	bpuo.mutation.SetSeriesID(id)
	return bpuo
}

// SetNillableSeriesID sets the "series" edge to the BlogSeries entity by ID if the given value is not nil.
func (bpuo *BlogPostUpdateOne) SetNillableSeriesID(id *uuid.UUID) *BlogPostUpdateOne {
	if id != nil {
		bpuo = bpuo.SetSeriesID(*id)
	}
	return bpuo
}
