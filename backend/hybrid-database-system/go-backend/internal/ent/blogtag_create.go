...
func (btc *BlogTagCreate) SetDescription(s string) *BlogTagCreate {
	btc.mutation.SetDescription(s)
	return btc
}

// SetNillableDescription sets the "description" field if the given value is not nil.
func (btc *BlogTagCreate) SetNillableDescription(s *string) *BlogTagCreate {
	if s != nil {
		btc.SetDescription(*s)
	}
	return btc
}

// SetColor sets the "color" field.
func (btc *BlogTagCreate) SetColor(s string) *BlogTagCreate {
	btc.mutation.SetColor(s)
	return btc
}

// SetNillableColor sets the "color" field if the given value is not nil.
func (btc *BlogTagCreate) SetNillableColor(s *string) *BlogTagCreate {
	if s != nil {
		btc.SetColor(*s)
	}
	return btc
...
func (btc *BlogTagCreate) SetPostCount(i int) *BlogTagCreate {
	btc.mutation.SetPostCount(i)
	return btc
}

// SetNillablePostCount sets the "post_count" field if the given value is not nil.
func (btc *BlogTagCreate) SetNillablePostCount(i *int) *BlogTagCreate {
	if i != nil {
		btc.SetPostCount(*i)
	}
	return btc
...
func (btc *BlogTagCreate) SetUpdatedAt(t time.Time) *BlogTagCreate {
	btc.mutation.SetUpdatedAt(t)
	return btc
}

// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (btc *BlogTagCreate) SetNillableUpdatedAt(t *time.Time) *BlogTagCreate {
	if t != nil {
		btc.SetUpdatedAt(*t)
	}
	return btc
...
func (btc *BlogTagCreate) defaults() {
	if _, ok := btc.mutation.PostCount(); !ok {
		v := blogtag.DefaultPostCount
		btc.mutation.SetPostCount(v)
	}
...
func (btc *BlogTagCreate) check() error {
	...
	if _, ok := btc.mutation.PostCount(); !ok {
		return &ValidationError{Name: "post_count", err: errors.New(`ent: missing required field "BlogTag.post_count"`)}
	}
	if _, ok := btc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "BlogTag.created_at"`)}
	}
	if _, ok := btc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "BlogTag.updated_at"`)}
	}
	return nil
}
...
func (btc *BlogTagCreate) createSpec() (*BlogTag, *sqlgraph.CreateSpec) {
	...
	if value, ok := btc.mutation.Color(); ok {
		_spec.SetField(blogtag.FieldColor, field.TypeString, value)
		_node.Color = value
	}
	if value, ok := btc.mutation.PostCount(); ok {
