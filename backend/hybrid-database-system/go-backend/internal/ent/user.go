...
// was not loaded in eager-loading.
func (e UserEdges) SocialLinksOrErr() ([]*SocialLink, error) {
	if e.loadedTypes[1] {
...
// was not loaded in eager-loading.
func (e UserEdges) BlogSeriesOrErr() ([]*BlogSeries, error) {
	if e.loadedTypes[6] {
...
// QuerySocialLinks queries the "social_links" edge of the User entity.
func (u *User) QuerySocialLinks() *SocialLinkQuery {
	return NewUserClient(u.config).QuerySocialLinks(u)
}
...
// QueryBlogSeries queries the "blog_series" edge of the User entity.
func (u *User) QueryBlogSeries() *BlogSeriesQuery {
	return NewUserClient(u.config).QueryBlogSeries(u)
}
